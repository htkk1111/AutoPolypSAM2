...
def parse_args():    
    ...
    parser.add_argument('-sam_ckpt', type=str, default='./checkpoints/sam2_hiera_base_plus.pt' , help='sam checkpoint address')
    parser.add_argument('-sam_config', type=str, default='sam2_hiera_b+' , help='sam checkpoint address')
    ...
    parser.add_argument('-comms_dtype', type=str, default=None, help='sam 2d memory bank size')
    parser.add_argument(
    '-data_path',
    type=str,
    default='./vpsdata',
